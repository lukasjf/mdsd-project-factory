...
/**
 * This is the item provider adapter for a {@link de.mdelab.languages.productionschema.IdentifiableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentifiableElementItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 ProductionschemaPackage.Literals.IDENTIFIABLE_ELEMENT__ID,
                 true,
                 false,
                 false,
    ...
    protected void addLabelPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_IdentifiableElement_label_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_IdentifiableElement_label_feature", "_UI_IdentifiableElement_type"),
                 ProductionschemaPackage.Literals.IDENTIFIABLE_ELEMENT__LABEL,
                 true,
                 false,
                 false,
    ...
    public String getText(Object object) {
        IdentifiableElement identifiableElement = (IdentifiableElement)object;
        return getString("_UI_IdentifiableElement_type") + " " + identifiableElement.getId();
    }
